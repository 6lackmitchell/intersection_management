...
for nn = 1:nTrials
    ...
    settings    = struct('x0',x0,'x0i',x0_new,'Tpath',{Tpath_new},'nAgents',nAgents,'nStates',nStates,'nControls',nControls,'xGoal',{xGoal},'Rpath',{Rpath},'path',{path},'im_used',im_used,'Lr',Lr,'SL',SL,'nNon',nNon,'pcca',pcca,'pmetric',pmetric,'cbf_type',cbf_type,'class_k_l0',class_k_l0);
