...
filename = strcat('datastore/adaptive_decentralized_reciprocal_follower/',dyn_mode,'/ff_cbf/input_constraints/high_energy/',con_mode,'_',num2str(nAgents),'MonteCarlo_N',num2str(nTrials),'.mat');
save(filename)
