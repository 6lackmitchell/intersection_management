...
parfor nn = 1:nTrials
    ...
    settings    = struct('x0',x0_new,'Tpath',{Tpath_new},'nAgents',nAgents,'nStates',nStates,'nControls',nControls,'xGoal',{xGoal},'Rpath',{Rpath},'path',{path},'im_used',im_used,'Lr',Lr,'SL',SL);
...
filename = strcat('datastore/',dyn_mode,'/monte_carlo/',con_mode,'_',num2str(nAgents),'MonteCarlo',num2str(nTrials),'_intersection_tests.mat');
save(filename)
...
% to_load  = 'datastore/dynamic_bicycle_rdrive_1u/monte_carlo/ff_cbf_cpca_4MonteCarlo1000_lowDfromCenter_highpriority.mat'
